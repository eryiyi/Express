...
//        final Resources res = getResources();
        ...
        final int defaultSelectedColor =0xFF33B5E5;
//        		res.getColor(R.color.default_line_indicator_selected_color);
        final int defaultUnselectedColor =0xFFBBBBBB; 
        		//res.getColor(R.color.default_line_indicator_unselected_color);
//        final float defaultLineWidth = 12;
//        final float defaultGapWidth = 4;
        final float defaultStrokeWidth =4;
//        mCentered =true;
